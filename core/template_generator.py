...
def create_test_template(output_path: str):
    ...
    instructions = [
        ...
        "3. Правильна відповідь/Тип (колонка C): Для питань з варіантами відповідей - українська літера правильної відповіді (А, Б, В, Г або АБ для множинного вибору). Для відкритих питань - правильна відповідь текстом.",
        ...
        "5. Варіанти відповідей (колонки E-H): Варіанти А, Б, В, Г. Залиште порожніми для відкритих питань.",
        "6. Тип завдання (колонка I): 'Тест 1' - один варіант, 'Тест М' - кілька варіантів, 'Відкрите' - відкрите питання.",
    ...
    headers = ['Номер питання', 'Питання', 'Правильна відповідь/Тип', 'Вага', 'Варіант А', 'Варіант Б', 'Варіант В', 'Варіант Г', 'Тип завдання']
    ...
    # Приклади даних
    example_data = [
        [1, "Яка мова програмування використовується для веб-розробки?", "А", 2, "JavaScript", "Python", "C++", "Java", "Тест 1"],
        [1, "Що таке HTML?", "Б", 1, "Мова програмування", "Мова розмітки", "База даних", "Операційна система", "Тест 1"],
        [2, "Які мови використовуються для фронтенду?", "АВ", 2, "HTML", "CSS", "Python", "Java", "Тест М"],
        [3, "Яке максимальне число в двійковій системі з 2 розрядів?", "3", 3, "", "", "", "", "Відкрите"],
        [4, "Скільки буде 2+2?", "В", 1, "3", "5", "4", "6", "Тест 1"]
    ]
    ...
    column_widths = [15, 50, 20, 10, 25, 25, 25, 25, 15]
